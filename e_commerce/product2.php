               ...
               <a href="product2.php" class="list-group-item" style="padding:0;margin:0;">
                  ...
                  <div class="col-md-9">
                     <div class="list-group-item-heading">
                        <h4>P119,000</h4>
                        <h4>KYMCO Like</h4>
                        <p class="pull-right">KYMCO</p>
                        <p style="color:darkblue;">Make</p>
                        <p class="pull-right">7.0 Liters</p>
                        <p style="color:darkblue;">Fuel Capacity</p>
                        <p class="pull-right">Automatic</p>
                        <p style="color:darkblue;">Transmission</p>
                        <p class="pull-right">115kg</p>
                        <p style="color:darkblue;">Dry Weight (without oil & Fuel)</p>
                        <p class="pull-right"> (Front / Rear)</br>DISC </br>WITH </br>BOSCH 9.1M abs /</br> DISC WITH </br>BOSCH 9.1M abs</p>
                        <p style="color:darkblue;">Brake System </br> (Front / Rear)</p>
                        </br>
                        </br>
                        <p class="pull-right">4-Stroke , </br>4V, Single Cylinder,</br> Air Cooled</p>
                        <p style="color:darkblue;">Engine Type</p>
                        </br>
                        </br>
                        <p class="pull-right">770mm</p>
                        <p style="color:darkblue;">Seat Height</p>
                        <p class="pull-right">Fuel Injected</p>
                        <p style="color:darkblue;">Fuel System</p>
                        <p class="pull-right"> 9.9 kW/9000 rpm</p>
                        <p style="color:darkblue;">Maximum Horse Power</p>
                         
                        <p class="pull-right">130/70-12</p>
                        <p style="color:darkblue;">Rear Tire</p>
                        <p class="pull-right">110/70-12</p>
                        <p style="color:darkblue;">front Tire</p>
                        <p class="pull-right">150 cc</p>
                        <p style="color:darkblue;">Displacement (cc)</p>
                        <p class="pull-right">12.5 Nm @ </br> 6,500 rpm</p>
                        <p style="color:darkblue;">Maximum Torque</p>
                        </br>
                        <p class="pull-right">Double Rear </br>Suspension</p>
                        <p style="color:darkblue;">Rear Suspension</p>
                        </br>
                        <p class="pull-right">1315 mm</p>
                        <p style="color:darkblue;">Wheelbase</p>
                        </br>
                        </br>
                        </br>
                        </br>
        ...
        <div class="col-md-12">
            <div class="thumbnail">
                ...
                <div class="caption">
                    ...
                    <h4><a href="product1.php">Kymco Like 150i</a></h4>
                    <div><button class="btn btn-primary" data-target="#buyme" data-toggle="modal" style="margin-left:10px; margin-bottom:10px">BUY</button></div>
                  ...
                  It provides a smooth and linear output throughout its power band.</br></br>The Kymco Like has a spacious under-seat storage compartment, 
                  which makes it very convenient for carrying personal items or groceries. With its combination of style, performance, and affordability, 
                  the Kymco Like is a great option for women riders. The Like 150i Noodoe version comes with built-in navigation and ABS.
                  Compared to other scooters, the Like has a slightly higher seat height and feels heavier to use and back out, but is still manageable for
                   women to use. The seat height for the Kymco Like is 770mm, while the curb weight is 115kg. The ground clearance is also a bit low at 120mm,
                    which means it tends to hit on humps especially if you have a backrider.</p>
                </div>
            </div>
        </div>
      </header>
         ...
         <div class="col-md-4">
            <div class="thumbnail">
               ...
               <div class="caption">
                  ...
                  <h4><a href="product.php">Yamaha Mio Fazzio</a></h4>
