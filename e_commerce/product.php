               ...
               <a href="product.php" class="list-group-item" style="padding:0;margin:0;">
                  ...
                  <div class="col-md-9">
                     <div class="list-group-item-heading">
                        ...
                        <p class="pull-right">YAMAHA</p>
                        <p style="color:darkblue;">Make</p>
                        <p class="pull-right">2022</p>
                        <p style="color:darkblue;">Registration date</p>
                        <p class="pull-right">Automatic</p>
                        <p style="color:darkblue;">Transmission</p>
                        <p class="pull-right">Dry</p>
                        <p style="color:darkblue;">Clutch Type</p>
                        <p class="pull-right">Wet sump</p>
                        <p style="color:darkblue;">Lubrication</p>
                        <p class="pull-right">TCI </br>(transistor</br> controlled</br> ignition)</p>
                        <p style="color:darkblue;">Ignition Type</p>
                        </br>
                        </br>
                        </br>
                        </br>
                        ...
                        <p class="pull-right">52.4×57.9mm</p>
                        <p style="color:darkblue;">Bore x Stroke (mm)</p>
                        <p class="pull-right">Air cooled, </br> 4-stroke,SOHC,</br> 2 Valve</p>
                        <p style="color:darkblue;">Engine Type</p>
                        </br>
                        </br>
                        <p class="pull-right">750mm</p>
                        <p style="color:darkblue;">Seat Height</p>
                        <p class="pull-right">5.1L</p>
                        <p style="color:darkblue;">Fuel Capacity (L)</p>
                        <p class="pull-right">Hydraulic single </br>disc brake / </br>Mechanical leading </br>  trailing drum brake</p>
                        <p style="color:darkblue;">Brake System </br> (Front / Rear) (L)</p>
                        </br>
                        </br>
                        </br>
                        <p class="pull-right">Telescopic fork</p>
                        <p style="color:darkblue;">Front Suspension</p>
                        <p class="pull-right">125cm3</p>
                        <p style="color:darkblue;">Displacement (cc)</p>
                        <p class="pull-right">LED</p>
                        <p style="color:darkblue;">Headlight(cc)</p>
                        <p class="pull-right">95kg</p>
                        <p style="color:darkblue;">Wet Weight (with oil & fuel)</p>
                        <p class="pull-right">0.84L</p>
                        <p style="color:darkblue;">Engine Oil Capacity (L)</p>
            ...
            <div class="thumbnail">
                ...
                <div class="caption">
                    ...
                    <p>The Yamaha Mio Fazzio is an icon of youthful expression complemented by high-quality mobility.
                     ...
                     aesthetically fashionable for every style. </br></br>The new Mio Fazzio /fätsiō/ is an icon of this generation’s of 
                     unique expression, embodying Yamaha’s desire to provide a fashionable style. It is given a modern, urban appeal, 
                     demonstrating dependability and high-quality mobility for a sophisticated lifestyle. It captures and incorporates 
                     colors fundamental to people’s personalities as the manifestation of a next-generation stylish AT</p>
                </div>
            </div>
        </div>
      </header>
